<x-admin-layout title="Add Learning Log">
    ...
    <div style="max-width:640px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:24px;">
            ...
            <h2 style="font-size:15px;font-weight:600;color:#f4f4f5;margin:0;">Add Learning Log</h2>
        </div>

        <div style="background:#111113;border:1px solid #1f1f22;border-radius:10px;padding:24px;">
            <form action="{{ route('admin.logs.store') }}" method="POST">
                @csrf

                @include('admin.logs._form', ['log' => null, 'categories' => $categories, 'statuses' => $statuses])
