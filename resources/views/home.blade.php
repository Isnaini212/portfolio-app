            ...
            <div class="mt-16 sm:mt-20 grid grid-cols-1 sm:grid-cols-2 gap-8 items-end">
                ...
                <div class="space-y-6" id="hero-bio">
                    ...
                    <div class="flex items-center gap-3" id="hero-social-row">
                        ...
                        <a href="https://{{ str_replace(['https://', 'http://'], '', $settings['profile_linkedin'] ?? 'linkedin.com/in/muhamad-isnaini') }}" target="_blank" rel="noopener noreferrer"
                           id="social-linkedin"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-12 items-stretch min-h-[420px]">
                            ...
                            <div class="lg:col-span-7 p-6 sm:p-10 flex flex-col justify-between space-y-6 relative z-10 bg-gradient-to-r from-zinc-950 via-zinc-900/95 to-transparent">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs sm:text-sm">
                                    ...
                                    {{-- LinkedIn --}}
                                    <a href="https://{{ str_replace(['https://', 'http://'], '', $settings['profile_linkedin'] ?? 'linkedin.com/in/muhamad-isnaini') }}" target="_blank" rel="noopener" class="flex items-center gap-3.5 p-3 rounded-xl bg-zinc-950/80 border border-zinc-800/80 hover:border-sky-500/40 transition-colors group">
                                        ...
                                        <div class="overflow-hidden">
                                            <p class="text-[10px] text-zinc-500 font-semibold uppercase tracking-wider">LinkedIn Profile</p>
                                            <p class="font-mono text-xs text-sky-300 font-medium truncate">{{ $settings['profile_linkedin'] ?? 'linkedin.com/in/muhamad-isnaini' }}</p>
                                        </div>
                                    </a>
                                </div>
